import type { AccessDecision, MeshNode, NetworkPolicy, SecurityEvent } from "../domain/types.js";
...
export class DevelopmentSigner {async sign(d:AccessDecision){return `dev-signature:${d.decisionId}`}} export class NoopThreatSink {async notify(_e:SecurityEvent){}}
