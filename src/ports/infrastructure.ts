...
export interface PolicyEnforcer { stage(commitId:UUID,policies:NetworkPolicy[],initiatedBy?:string):Promise<void>; commit(commitId:UUID):Promise<void>; rollback(commitId:UUID):Promise<void>; isolateNode(nodeId:UUID):Promise<void>; restoreNode(nodeId:UUID):Promise<void>; }
